//--------------------------------------------------------------------------------------------------
//
// Copyright (C) 2001-2014 LaVision GmbH.  All Rights Reserved.
//
//--------------------------------------------------------------------------------------------------
...
extern "C" int EXPORT WriteIM7( const char* theFileName, bool isPackedIMX, BufferType* myBuffer, AttributeList* myList )
{
